...
import static constant.SampleResources.PEN_WIDTH_SIGMA_CONTROL;
import static constant.SampleResources.PEN_WIDTH_SIGMA_PAD;
import static constant.SampleResources.RES_IMG_LED1_GREEN;
import static constant.SampleResources.loadImage;

import static constant.SampleResources.RES_IMG_LED1_YELLOW;
import static constant.SampleResources.RES_IMG_SIGNATURE_SIGMA;
import static constant.SampleResources.RES_IMG_BTN_OK_BW;
import static constant.SampleResources.RES_IMG_BTN_CANCEL_BW;
import static constant.SampleResources.RES_IMG_LOGO_ZETA;
import static constant.SampleResources.PEN_WIDTH_ZETA_CONTROL;
import static constant.SampleResources.PEN_WIDTH_ZETA_PAD;
import static constant.SampleResources.RES_IMG_LED2_GREEN;
import static constant.SampleResources.RES_IMG_LED2_YELLOW;
import static constant.SampleResources.RES_IMG_SIGNATURE_ZETA;
import static constant.SampleResources.RES_IMG_LOGO_OMEGA;
import static constant.SampleResources.PEN_WIDTH_OMEGA_CONTROL;
import static constant.SampleResources.PEN_WIDTH_OMEGA_PAD;
import static constant.SampleResources.RES_IMG_SIGNATURE_OMEGA;
import static constant.SampleResources.RES_IMG_BTN_OK;
import static constant.SampleResources.RES_IMG_BTN_CANCEL;
import static constant.SampleResources.RES_IMG_BTN_RETRY;
import static constant.SampleResources.RES_IMG_BTN_SCROLL;
import static constant.SampleResources.RES_IMG_LOGO_GAMMA;
import static constant.SampleResources.PEN_WIDTH_GAMMA_CONTROL;
import static constant.SampleResources.PEN_WIDTH_GAMMA_PAD;
import static constant.SampleResources.RES_IMG_LOGO_DELTA;
import static constant.SampleResources.RES_IMG_SIGNATURE_GAMMA;
import static constant.SampleResources.PEN_WIDTH_DELTA_CONTROL;
import static constant.SampleResources.PEN_WIDTH_DELTA_PAD;
import static constant.SampleResources.RES_IMG_LED3_GREEN;
import static constant.SampleResources.RES_IMG_LED3_YELLOW;
import static constant.SampleResources.RES_IMG_SIGNATURE_DELTA;
import static constant.SampleResources.RES_IMG_LOGO_ALPHA;
import static constant.SampleResources.PEN_WIDTH_ALPHA_CONTROL;
import static constant.SampleResources.PEN_WIDTH_ALPHA_PAD;
import static constant.SampleResources.RES_IMG_SIGNATURE_PENDISPLAY;
import static constant.SampleResources.RES_IMG_BTN_OK_PENDISPLAY;
import static constant.SampleResources.RES_IMG_BTN_CANCEL_PENDISPLAY;
import static constant.SampleResources.RES_IMG_BTN_RETRY_PENDISPLAY;
import static constant.SampleResources.RES_IMG_LOGO_PENDISPLAY;
import static constant.SampleResources.PEN_WIDTH_PEN_DISPLAY_CONTROL_MAX;
import static constant.SampleResources.PEN_WIDTH_PEN_DISPLAY_CONTROL_MIN;
...
import static constant.SampleResources.SCROLL_SPEED_OMEGA;
import static constant.SampleResources.SCROLL_SPEED_GAMMA;
import static constant.SampleResources.SCROLL_SPEED_DELTA;
import static constant.SampleResources.FONT_NAME_PAD;
